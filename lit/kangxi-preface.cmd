...
* %cite-title --> '"Imperially-Made Preface [unto the] K'ang\-hee Dictionary"'
* %title --> "Imperially-Made Preface [unto the] K'ang\-hee Dictionary" 《御製康熙字典序》
* %description -->
...
# .《御製康熙字典序》
  "Imperially-Made Preface .[unto the] (K'ang\-hee|康熙) Dictionary"


--
The [(K'ang\-hee|康熙) Dictionary] is an impressive work.
Commissioned by the [(K'ang\-hee|康熙) Emperor],
...
--
--
(K'ang\-hee|康熙)'s preface names the work .字典, "character canon",
which ultimately became the modern Chinese term for dictionary.

--

[(K'ang\-hee|康熙) Dictionary]:
...
--
--
Though the preface text was composed by the emperor (K'ang\-hee|康熙) himself,
