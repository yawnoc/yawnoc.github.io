...
%%
  %title
    "\sun-tzu's Computational Classic: Volume~I" 《孫子算經\.卷上》 \P15
...
----
Chinese source text: \a[12], \b[148], \c[52075], \d[20]. \+
\d-default
----
...
* **\a[12] is missing four whole pages after 一千二百九十六**,
  ...
  until 四人分之 after 四七二十八 in [\P17] ["i 17"].
  ...
  @@[21]
    https://ctext.org/library.pl?if=en&file=86926&page=21
  @@
  @@[24]
    https://ctext.org/library.pl?if=en&file=86926&page=24
  @@
====
...
\cite-this-page[
  "\sun-tzu's Computational Classic: Volume~I \P15"
][
  sun-tzu-i-15
][
  ~~``{Sun}~{Tz{\u u}'s} {Computational} {Classic}: {Volume}~{I} {\P15}''~~
]
