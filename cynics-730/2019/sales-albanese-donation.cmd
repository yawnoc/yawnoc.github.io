...
* %title --> A cynic's 7.30: Albanese on donations (3~Sep 2019)
...
[Leigh Sales:]{.interview-host}: leigh-sales-2019-09-03.jpg
[Anthony Albanese:]{.interview-guest}: anthony-albanese-2019-09-03.jpg
...
||||{.interview}
  ...
  _Except Kaila Murnain of course, but she's dead to us now,
  so she doesn't count as a person._
  --
  --{.interview-guest}
  ...
  _All right Mr~Smarty-pants it's just the first question._
  --
  --{.interview-host}
  ...
  the [ICAC] can undertake its work.
  --
  --{.interview-guest}
  There's clearly a need for structural reform
  ...
  ![Anthony Albanese:]
  --{.interview-guest .thought}
  _Yes of course there should, but I'm not allowed to say that.
  So cue swipe at the Coalition:_
  --
  --{.interview-guest}
  ...
  --
  --{.interview-guest .thought}
  _which we would like to keep in house for obvious reasons_.
  --
  --{.interview-guest}
  ...
  --
  --{.interview-guest .thought}
  _and definitely not in Federal Labor_,
  --
  --{.interview-guest}
  ...
  --
  --{.interview-guest .thought}
  _and assuredly, I say to you, not in Federal Labor_.
  --
  ...
  --
  --{.interview-guest .thought}
  _although if you asked me to explain exactly what makes it stronger than
  the New South Wales branch's audit process, I wouldn't be able to_.
  --
  ...
  ![Anthony Albanese:]
  --{.interview-guest .thought}
  _Oh yes, and it's one of the few things for which
  there's bipartisan consensus too._
  --
  --{.interview-guest}
  ...
  --
  --{.interview-guest .thought}
  _and until it's over I shall be using the nifty
  "I can't comment on matters relating to an ongoing investigation"_.
  --
  --{.interview-guest}
  ...
  --
  --{.interview-guest .thought}
  _However, if we are talking about political interference
  in the form of donations from those linked to the Chinese Communist Party,
  I think we agree with the Liberals: How good's money?_
  --
  --{.interview-host}
  [...]
  --
