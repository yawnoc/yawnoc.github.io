...
- queue_position: BEFORE #.cynicism.footer-properties-override
* %copyright-prior-years --> get_year@%date-created--
* %copyright-exception -->
    , except the [original Bolt Report interview],
...
[Original Bolt Report interview]:
  https://www.heraldsun.com.au/blogs/andrew-bolt/gladys-liu-car-crash-interview-on-her-links-to-chinas-dictators/news-story/2d00bf2a43cc0ca6047cc6873736d067
[youtube]:
  https://www.youtube.com/watch?v=qoy8mKRmALA


## Gladys Liu discusses membership of various Chinese Associations.


[Andrew Bolt:]{.interview-host}: andrew-bolt-2019-09-10.jpg
[Gladys Liu:]{.interview-guest}: gladys-liu-2019-09-10.jpg
...
||||{.interview}
  ...
  _However, my memory shall be magically restored within the next 24~hours,
  and I shall release a [statement] tomorrow, Wednesday the 11th,
  confirming that I was a member of the
  Guangdong Overseas Exchange Association in~2011._
  --
  [statement]:
  ...
  --
  --{.interview-guest .thought}
  _So there I was in an honorary leadersip role,
  ...
  what the hell was I even doing there, and how naive/stupid can I be eh?_
  --
  --{.interview-host}
  [...]
  --
  ...
  [United Front (Work Department)]: true or not?
  --
  ...
  <small>
    ...
    [UCCA's website] ([archived version])
    along with her former role as
    "Victorian Premier's Chinese Affairs Director" (.維州州長華人事務主任).
  </small>
  --

  [UCCA's website]: http://uccaai.org/
  [archived version]: https://web.archive.org/web/20190912155936/http://uccaai.org/
  ...
  --
  --{.interview-guest .thought}
  _And by "the interests of Australia" I of course mean
  "the interests of Australia's government"._
  --
  --{.interview-host}
  [...]
  --
  ...
  --
  --{.interview-guest .thought}
  _which, depending on who you're talking to, translates to either
  ...
  Do you hear me? Heroes!"_
  --

  [1967]: https://en.wikipedia.org/wiki/Hong_Kong_1967_leftist_riots
  ...
  --
  --{.interview-guest .thought}
  _because, having joined the Australian government,
  ...
  ![Gladys Liu:]
  --{.interview-guest .thought}
  _Aren't we all, except Andrew Hastie and a few others?_
  --
  --{.interview-guest}
