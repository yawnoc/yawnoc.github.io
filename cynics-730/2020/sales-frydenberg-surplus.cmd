...
@@[archived version]
  https://web.archive.org/web/20200315042335/\
    https://www.abc.net.au/7.30/\
      josh-frydenberg-says-the-governments-surplus/\
      12052830
@@
...
||||||{.interview}
  ...
  ----{.gt}
  {I hope not,
  I would really like to see a surplus before the next election...}
  ----
  ----{.g}
  ...
  ----
  ----{.gt}
  {In other words, if we do avoid recession,
  then I'll be judging it on the fact that we avoided recession,
  but if we don't avoid recession,
  then I won't be judging it on the fact that we didn't avoid recession.}
  ----
  ----{.g}
  [...]
  ----
  ...
  \josh-frydenberg
  ----{.gt}
  {Ouch... Er, my premature rush did help us get re-elected,
  so I think it says good things
  about my political maturity and judgement?}
  ----
  ----{.g}
  ...
  \leigh-sales
  ----{.ht}
  {Oh cheer up now Josh, out of everyone I have on this show,
  you talk over me the least.}
  ----
  ----{.h}
